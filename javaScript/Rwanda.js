...
function displayData() {
    ...
    } else if (dropdownSelectedValue == "Vaccinated Population per hundred" && toggleButtonValue == "Daily") {
        isDisplayingDeathCases = false;
        isDisplayingVaccines = true;
        isWeekly = false;
        displayDailyVaccinatedPeople();
    } else if (dropdownSelectedValue == "Vaccinated Population per hundred" && toggleButtonValue == "Weekly") {
        isDisplayingDeathCases = false;
        isDisplayingVaccines = true;
          isWeekly = true;
...
function displayTravelRestritions() {
    ...
    document.getElementById('travel-data').style.display = "grid";
}

function closeDataTravelRestritions() {
    document.getElementById('travel-one').style.display = "grid";
...
function displayAirlineRestrictions() {
    ...
    document.getElementById('airline-data').style.display = "grid";
}

function closeAirlineRestrictions() {
    document.getElementById('airline-one').style.display = "grid";
...
function displayQuarantineRestrictions() {
    ...
    document.getElementById('quarantine-data').style.display = "grid";
}

function closeQuarantineRestrictions() {
    document.getElementById('quarantine-one').style.display = "grid";
...
function displayCertificateRestrictions() {
    ...
    document.getElementById('certificate-data').style.display = "grid";
}

function closeCertificateRestrictions() {
    document.getElementById('certificate-one').style.display = "grid";
